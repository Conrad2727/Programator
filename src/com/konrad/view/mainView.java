	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				sl_panel.putConstraint(SpringLayout.NORTH, button1, 157,
				...
				sl_panel.putConstraint(SpringLayout.EAST, button1, 0,
						SpringLayout.EAST, textField);
				sl_panel.putConstraint(SpringLayout.NORTH, textField, 68,
						SpringLayout.NORTH, panel);
				panel.add(textField);
				...
				sl_panel.putConstraint(SpringLayout.EAST, lblLogin, -316,
						SpringLayout.EAST, panel);
				sl_panel.putConstraint(SpringLayout.WEST, textField, 19,
						SpringLayout.EAST, lblLogin);
				sl_panel.putConstraint(SpringLayout.NORTH, lblLogin, 3,
						SpringLayout.NORTH, textField);
				panel.add(lblLogin);

				JLabel lblNewLabel = new JLabel("Has\u0142o");
				sl_panel.putConstraint(SpringLayout.NORTH, passwordField, -3,
						SpringLayout.NORTH, lblNewLabel);
				sl_panel.putConstraint(SpringLayout.NORTH, lblNewLabel, 27,
						SpringLayout.SOUTH, lblLogin);
				sl_panel.putConstraint(SpringLayout.EAST, lblNewLabel, 0,
						SpringLayout.EAST, lblLogin);
				...
				lblNewLabel_2 = new JLabel(
						"Prosz\u0119 wype\u0142nij Login i Has\u0142o.");
				sl_panel.putConstraint(SpringLayout.NORTH, lblNewLabel_2, 6,
						SpringLayout.NORTH, lblNewLabel_1);
				sl_panel.putConstraint(SpringLayout.EAST, lblNewLabel_2, -24,
						SpringLayout.EAST, panel);
				panel.add(lblNewLabel_2);

				label = new JLabel("");
				sl_panel.putConstraint(SpringLayout.SOUTH, label, -10,
						SpringLayout.SOUTH, panel);
				sl_panel.putConstraint(SpringLayout.EAST, label, -176,
						SpringLayout.EAST, panel);
				panel.add(label);
